...
Game :: Game(Point tl, Point br)
 : topLeft(tl), bottomRight(br), rifle(br), type(random(0,3))
{
...
Bird* Game :: createBird()
{
   ...
   // TODO: Fill this in
    ...
    if (type == 0)
        newBird = new Standard();
    
    if (type == 1)
        newBird = new Sacrated();
...
void Game :: draw(const Interface & ui)
{
   ...
   drawNumber(scoreLocation, score);
    ...
    if(birdsOutside % 5 == 0 && birdsOutside != 0)
    {
                       score = score-5;
                       birdsOutside ++;
    }
    ...
    drawNumber(birdsOut, birdsOutside);
